...
logger = logging.getLogger("JobScraper.SunstoneTalent")

BASE_URL = "https://sunstonetalent.com"

def fetch_sunstonetalent_jobs():
    """
    Scrapes Sunstone Talent job listings via HTML parsing.
    """
    search_paths = [
