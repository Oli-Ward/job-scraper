...
logger = logging.getLogger("JobScraper.BeyondRecruitment")

BASE_URL = "https://www.beyondrecruitment.co.nz/disciplines/technology-transformation-and-digital"

def fetch_beyondrecruitment_jobs():
    """
    Scrapes Beyond Recruitment job listings via HTML parsing.
    """
    headers = {
        "User-Agent": (
    ...
    for card in job_cards:
        try:
            ...
            if job_url and not job_url.startswith("http"):
                job_url = "https://www.beyondrecruitment.co.nz" + job_url
